...
namespace BaiTapLonNet.Migrations
{
    ...
    [Migration("20230523093852_updatedb10")]
            ...
            modelBuilder.Entity("BaiTapLonNet.Models.BatDongSan", b =>
                {
                    ...
                    b.Property<DateTime>("GiaCapNhat")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 23, 16, 38, 52, 666, DateTimeKind.Local).AddTicks(5403));
            ...
            modelBuilder.Entity("BaiTapLonNet.Models.TaiKhoan", b =>
                {
                    ...
                    b.Property<string>("HinhAnh")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("https://res.cloudinary.com/df6xlriko/image/upload/v1683367962/avt_xl7z3r.jpg");
